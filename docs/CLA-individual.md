...
Thank you for your interest in contributing to LeavePilot Community Edition
and the related Premium and OEM deliveries (the "Project"). To clarify the
intellectual property license granted with Contributions from any person, the
Project must have on file a signed Contributor License Agreement ("CLA") from
...
the Licensor and the Project's users. It does not change your rights to use
your own Contributions for any other purpose.

The "Licensor" is Alexey Lavrentev, the natural person named as the licensor in
`LICENSE.md` and `NOTICE`. Throughout this Agreement, "the Licensor" means that
person and any successor entity that publishes the Project under the terms
stated in `LICENSE.md`.

This is a fork of the Apache Software Foundation Individual Contributor License
Agreement (version 2.2), adapted for this Project. The Apache definitions,
copyright grant, patent grant, representations and disclaimer are preserved; the
preamble, the proprietary-relicensing paragraph in section 2, the applicable-law
clause and the signature block are specific to this Project.
...
to Your Contributions. This Agreement is a license, not an assignment: it does
not transfer Your copyright to the Licensor, and it does not restrict what You
may do with Your own work anywhere else.
...
by You to the Licensor for inclusion in, or documentation of, the Project (the
...
The Licensor may, in its sole discretion, distribute Your Contribution under
any licensing terms, **including proprietary and closed-source terms**. This
expressly includes distribution of Your Contribution as part of the LeavePilot
Premium module, which is sold commercially and is not published under the
Elastic License 2.0, and as part of OEM or white-label deliveries, in which the
software is supplied under a customer's own brand on separately negotiated
terms. Without this paragraph a Contribution could not be taken into the
Premium module or into an OEM delivery at all.
...
## 5. No Obligation to Support; Disclaimer
...
This Agreement is governed by the laws of the Russian Federation. Any disputes
arising out of or in connection with this Agreement shall be resolved through
negotiation in good faith. If negotiation fails, disputes shall be resolved in
the courts of Moscow under Russian law. This clause is consistent with section 9
of `docs/EULA.md` and is stated here as the default; its sufficiency for the
Project's purposes is subject to final confirmation by the Licensor's legal
counsel.

## Signature

Please sign and date below. Acceptance through CLA-Assistant (a GitHub
signature recorded against Your GitHub account) is equivalent to a handwritten
...
Public GitHub username (optional): _____________________________________
...
The canonical text of this agreement is the file `docs/CLA-individual.md` in the
repository root. The GitHub Gist linked by CLA-Assistant is a copy, kept in
sync with this file before each CLA version bump; if the two ever differ, this
file in the repository is the controlling text.
