  ...
  const Company = sequelize.define("Company", {
    ...
    sso_auth_config : {
        ...
        set : function(val){
          ...
          const toStore = Object.assign({}, val);
        ...
        get : function(){
          let val = this.getDataValue('sso_auth_config');
          try {
            val = JSON.parse(val);
          } catch(err) {
            // eslint-disable-next-line no-console
    ...
    Company.scopeAssociate = function( _models ) {
...
//        });
    ...
    Company.prototype.get_ldap_server = function(){
        ...
        const tlsOptions = config.allow_unauthorized_cert ? { rejectUnauthorized: false } : {};
    ...
    Company.prototype.get_default_date_format_for_date_picker = function() {
        ...
        if ( Object.prototype.hasOwnProperty.call(moment_to_datepicker_map, self.get_default_date_format()) ) {
    ...
    Company.prototype.normalise_date = function(date_str) {
        return dayjs.utc(date_str, this.get_default_date_format()).format('YYYY-MM-DD');
      };
    ...
    Company.prototype.get_today = function() {
        ...
        return dayjs.utc(
          dayjs.utc().tz(self.timezone).format('YYYY-MM-DD')
        );
      };
