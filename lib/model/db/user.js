...
module.exports = function(sequelize, DataTypes) {
  ...
  const User = sequelize.define("User", {
      ...
      start_date : {
          ...
          get: function(){
            return dayjs.utc(this.getDataValue('start_date')).format('YYYY-MM-DD');
          },
      },
      end_date : {
          type         : DataTypes.DATE,
          ...
          get: function(){
            ...
            return dayjs.utc(endDate).format('YYYY-MM-DD');
          },
      },
  }, {
      indexes : [
...
function get_instance_methods(sequelize) {
  ...
  return {
    ...
    /*
      ...
      Company.get_today() is already a UTC dayjs at the start of the company's
      calendar day, so it compares directly against end_date.
    */
    is_active : function(today){
      const boundary = today
        || (this.company ? this.company.get_today() : dayjs.utc().startOf('day'));

      return this.end_date === null || dayjs.utc(this.end_date).isSameOrAfter(boundary);
    },
    ...
    /*
      ...
      - the rows come back as partially loaded model instances, and sequelize
        ...
        is_active() reads end_date, and dayjs.utc(undefined) is now, so a
    ...
    */
    ...
    reload_with_leave_details : function(args){
      ...
      ]).then(function([leaves, department, _schedule]){
    ...
    reload_with_session_details : function(){
      ...
      return Promise.all([
        ...
        self.promise_schedule_I_obey(),
      ]).then(function([users, company, _schedule]){
    ...
    record_email_addressed_to_me : function(email_obj) {
      ...
      if ( ! email_obj ||
        ! Object.prototype.hasOwnProperty.call(email_obj, 'subject') ||
        ! email_obj.subject ||
        ! Object.prototype.hasOwnProperty.call(email_obj, 'body') ||
        ! email_obj.body
      ) {
        throw new Error(
  ...
  return {
    ...
    */
    get_active_user_filter : function(today){
      const boundary = today || dayjs.utc().startOf('day');
