...
function add_user(args) {
  const validated_args = add_user_interface_schema.validate(args);
...
function add_users_in_bulk(args) {
  const _bulk_header = args.bulk_header,
...
function validate_email_to_be_free(args) {
  const validate_args = validate_email_to_be_free_schema.validate(args);
