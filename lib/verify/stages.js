...
const stages = Object.freeze([
  ...
  timed('unit-coverage', npm, ['run', 'test:coverage']),
  timed('sqlite-migration', node, ['bin/db_update.js'], {env: {NODE_ENV: 'test', DB_DIALECT: 'sqlite'}}),
  timed('css-build-diff', node, ['bin/verify_css.js']),
  timed('package', npm, ['pack', '--dry-run', '--json']),
  Object.freeze({id: 'browser-1', command: node, args: Object.freeze(['bin/test.js', '--integration-only', '--keep-going', '--shard=1/4']), dependencies: Object.freeze([]), resource: 'browser', deadlineMs: 1800000, prerequisite: chromePrerequisite}),
  Object.freeze({id: 'browser-2', command: node, args: Object.freeze(['bin/test.js', '--integration-only', '--keep-going', '--shard=2/4']), dependencies: Object.freeze([]), resource: 'browser', deadlineMs: 1800000, prerequisite: chromePrerequisite}),
  Object.freeze({id: 'browser-3', command: node, args: Object.freeze(['bin/test.js', '--integration-only', '--keep-going', '--shard=3/4']), dependencies: Object.freeze([]), resource: 'browser', deadlineMs: 1800000, prerequisite: chromePrerequisite}),
  Object.freeze({id: 'browser-4', command: node, args: Object.freeze(['bin/test.js', '--integration-only', '--keep-going', '--shard=4/4']), dependencies: Object.freeze([]), resource: 'browser', deadlineMs: 1800000, prerequisite: chromePrerequisite}),
  Object.freeze({id: 'mysql-dialect', command: node, args: Object.freeze(['bin/test.js', 't/unit/db_migrations_data.js']), dependencies: Object.freeze([]), resource: 'mysql', deadlineMs: 300000, prerequisite: Object.freeze({command: node, args: Object.freeze(['-e', "if (!process.env.DB_HOST) process.exit(1)"]), setup: 'Start MySQL 8.0.45 and set DB_HOST, DB_PORT, DB_NAME, DB_USER, DB_PASSWORD'}), env: {NODE_ENV: 'test', TEST_DB_DIALECT: 'mysql'}}),
