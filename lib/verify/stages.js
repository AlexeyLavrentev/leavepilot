...
require('./ci_calibration').validateCiCalibration(timings.external);
...
const stages = Object.freeze([
  ...
  Object.freeze({id: 'test-prerequisite-timeout', command: node, args: Object.freeze(['-e', "console.log('unexpected-stage-start')"]), dependencies: Object.freeze([]), resource: 'test', deadlineMs: 1000, prerequisite: Object.freeze({command: node, args: Object.freeze(['-e', 'setInterval(() => {}, 1000000)']), setup: 'test fixture prerequisite'})}),
  ...
  Object.freeze({id: 'test-secret-output', command: node, args: Object.freeze(['t/fixtures/verify/secret_failure.js']), dependencies: Object.freeze([]), resource: 'test', deadlineMs: 1000}),
  Object.freeze({id: 'test-stream-output', command: node, args: Object.freeze(['t/fixtures/verify/stream_output.js']), dependencies: Object.freeze([]), resource: 'test', deadlineMs: 1000}),
  Object.freeze({id: 'test-nested-timeout', command: node, args: Object.freeze(['bin/test.js', 't/fixtures/verify/nested_hang.js']), dependencies: Object.freeze([]), resource: 'test', deadlineMs: 8000}),
  Object.freeze({id: 'test-exit-tree', command: node, args: Object.freeze(['-e', "const {spawn} = require('child_process'); const child = spawn(process.execPath, ['-e', 'setInterval(() => {}, 1000000)'], {stdio: 'ignore'}); console.log('tree-grandchild=' + child.pid); process.exit(0);"]), dependencies: Object.freeze([]), resource: 'test', deadlineMs: 1000}),
